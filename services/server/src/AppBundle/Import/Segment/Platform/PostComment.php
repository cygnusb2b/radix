...
class PostComment extends Platform
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'platform_comment_postcomment';
    }
    ...
    {
        // can be empty in component data
                ...
                if (!empty($c['import'])) {
                    if (!empty($c['import']['userId'])) {
                        ...
                        if (!empty($identity)) {
                            $doc['account'] = [
                                'id' => $identity['_id'],
                                // it freaks out when it find identity-internal here so making it static
                                //'type' => $identity['_type'];
        ...
        $transformer = new Transformer\PostComment();

            ...
            render: function() {
                return (
                    React.createElement("form", {className: "databaseForm", onSubmit: this.handleSubmit},
                        ...
                        React.createElement("div", {className: ""},
                            React.createElement("div", {className: ""},
                                React.createElement("label", {htmlFor: "username", className: ""}, "Username"),
                                React.createElement("input", {name: "username", ref: "username", type: "text", id: "username", className: "", placeholder: "Username (for logging in, can also be your email)", required: "required"})
                            )
                        ),
                        React.createElement("div", {className: ""},
                            React.createElement("div", {className: ""},

React.createClass({ displayName: 'FormResetPasswordGenerate',
    ...
    _getForm: function() {
        ...
        return React.createElement('form', { className: 'database-form', onSubmit: this.props.onSubmit },
            React.createElement(Radix.Components.get('FormInputText'), { ref: this.props.fieldRef, name: 'customer:primaryEmail', label: 'Username or Email', required: true, wrapperClass: 'username' }),

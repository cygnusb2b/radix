React.createClass({ displayName: 'FormEmailSubscription',
    ...
    _getForm: function() {
        ...
        return React.createElement('form', { autocomplete: false, className: 'database-form', onSubmit: this.props.onSubmit },
            ...
            React.createElement(Radix.Components.get('FormSelectCountry'), { onChange: handleChange, name: 'customer:primaryAddress.countryCode', wrapperClass: 'countryCode', selected: customer.primaryAddress.countryCode }),
            ...
            React.createElement(Radix.Components.get('FormQuestion'), { onChange: handleChange, tagKeyOrId: 'employee-size', answers: customer.answers }),
            React.createElement(Radix.Components.get('FormQuestion'), { onChange: handleChange, tagKeyOrId: 'sales-volume', answers: customer.answers }),

...
(function(Radix, undefined) {
    ...
    function Forms()
    {
        this.components = {
            ...
            FieldWrapper: React.createClass({ displayName: 'FieldWrapper',
            ...
            SelectCountry: React.createClass({ displayName: 'SelectCountry',
                ...
                return (
                    React.createElement("div", null,
                        React.createElement("div", {className: "inquiry-container"},
                            React.createElement(Radix.Forms.getComponent('SelectCountry'), { selected: this.state.customer.primaryAddress.countryCode, name: 'countryCode', label: 'Country' }),
